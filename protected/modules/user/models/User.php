...
class User extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return ((get_class(Yii::app()) == 'CConsoleApplication' || (get_class(Yii::app()) != 'CConsoleApplication' && Yii::app()->getModule('user')->isAdmin())) ? array(
                    ...
                    array('status', 'in', 'range' => array(self::STATUS_NOACTIVE,
                            self::STATUS_ACTIVE, self::STATUS_BANNED)),
                    ...
                    array('id, username, password, email, activkey, create_at, lastvisit_at, superuser, status',
                        'safe', 'on' => 'search'),
    ...
    public function getDefaultProfile()
    {
        if ($this->profile != null) {
            ...
            $profile_fields = ProfileField::model()->findAll();
            $profile = new Profile;
