...
class LightOpenID
{
    ...
    static protected $ax_to_sreg = array(
        ...
        'passport/sn'             => 'passport_sn',
        'passport/issued'         => 'passport_issued',
        'passport/address'        => 'passport_address',
        'passport/exp'            => 'passport_exp',
        'passport/isued/date'     => 'passport_issued_date'
        );
    public $language = 'ru';
    ...
    function discover($url)
    {
        ...
        for ($i = 0; $i < 5; $i ++) {
            ...
            if($this->language != 'ru'){
                $server = 'http://id.uz/uz/openid/provider';
            }
    ...
    function authUrl($identifier_select = null)
    {
        ...
        /*Закомментировал, т.к. в старых браузерах не работает 2 версия openid
        if ($this->version == 2) { 
